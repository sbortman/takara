			...
			wfs.WFS_Capabilities(
				...
				FeatureTypeList {
					...
					FeatureType( 'xmlns:tiger': "http://www.census.gov" ) {
						...
						ows.Keywords {
							ows.Keyword( 'landmarks' )
							ows.Keyword( 'DS_poly_landmarks' )
							ows.Keyword( 'manhattan' )
							ows.Keyword( 'poly_landmarks' )
						}
						DefaultSRS( 'http://www.opengis.net/gml/srs/epsg.xml#4326' )
						ows.WGS84BoundingBox {
							ows.LowerCorner( '-74.047185 40.679648' )
							ows.UpperCorner( '-73.90782 40.882078' )
						}
					}
/*
    <FeatureType xmlns:tiger="http://www.census.gov">
    ...
    <FeatureType xmlns:sf="http://www.openplans.org/spearfish">
      ...
      <DefaultSRS>http://www.opengis.net/gml/srs/epsg.xml#26713</DefaultSRS>
      <ows:WGS84BoundingBox>
